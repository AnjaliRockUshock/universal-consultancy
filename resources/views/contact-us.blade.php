    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="right-bar position-sticky top-0">
                    <div class="main-service">
                        ...
                        <h2 class="comment-title" style="color: #fff;">Get in Touch</h2>
                        <p style="color: #8b8b8b;padding-bottom: 10%">Reach out to us for tailored digital solutions that drive results sollicitudin nec.</p>
                            ...
                            <div class="contact-address-item">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-10">
                                        <p style="color: #8b8b8b;">Phone Number</p>
                                        <a style="font-size: medium;" href="callto:+91 7575884020">+91 7575884020</a>
                                    </div>
                                </div>
                            </div>
                            <div class="contact-address-item">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-10">
                                        <p style="color: #8b8b8b;">Email Address</p>
                                        <a style="font-size: medium;" href="callto:Contact@theuniversalconsultinggroup.com">Contact@theuniversalconsultinggroup.com</a>
                                    </div>
                                </div>
                            </div>
                            <div class="contact-address-item">
            ...
            <div class="col-lg-6">
                <div class="left-bar">
                    <div class="user-comment">
                        <h1 class="comment-title" style="font-size: 3rem;">Let's Talk About Your Next Project</h1>
                        <div class="comment-box">
                            <form class="row g-4" action="{{ route('askQuestions.send') }}" method="POST">
                                @csrf
                                <div class="col-md-6">
...
<div class="map">
    <div class="row">
        <div class="col-12">
            <iframe
                src="https://www.google.com/maps?q=21.633220398058455,73.0052172556909&hl=en&z=15&output=embed"
                width="100%"
                height="800"
                frameborder="0"
                style="border:0;"
